...
public class Commands<T> implements CommandExecutor{
	...
	static public String displayUsage(String command) {
		...
		case "msgall":
			...
			break;
		default:
			String error = cacPrefix + ChatColor.RED + "Error: " + ChatColor.DARK_RED + "Usage missing from system. Please contact " + ChatColor.RED + "CallMeBlind " + ChatColor.DARK_RED + "on the plugin dev site.";
			return error;
		}
		return usage;
	}
	...
	static public void sendHelp(Player player) {
		...
		String[] helpList = {helpHeader, helpGM, helpFly, helpMSG};
